        ...
        {jobs.map((job, index) => (
          <SwiperSlide key={job.id}>
            <motion.div
              ...
              className="w-full max-w-sm h-auto overflow-hidden rounded-2xl shadow-md border border-gray-200 bg-white p-1 mx-auto"
            >
              <div className="p-4 bg-gray-50 mx-2 my-2 rounded-xl">
                <div className="flex items-center justify-between">
                  <div className="flex-1 pr-4">
                    ...
                    <h3 className="job-title text-xl font-semibold text-gray-800 mb-3">
                      {job.title.charAt(0).toUpperCase() + job.title.slice(1)}
                    </h3>
                    <p className="text-sm text-gray-600 description mb-3">
                      {job.description || "No description available"}...
                    ...
                    <div className="flex gap-2 text-sm text-gray-600">
                      <span className="px-2 py-1 border border-gray-300 rounded-full bg-white">
                        {job.type || "N/A"}
                      </span>
                      <span className="px-2 py-1 border border-gray-300 rounded-full bg-white">
                        {job.level || "N/A"}
              ...
              <div className="p-4 bg-white">
                <div className="flex justify-between items-center space-x-4">
                  ...
                  <Link
                    href={`/jobs/${job.id}`}
                    className="bg-[var(--primary)] text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-opacity-90 transition-all duration-200"
                    aria-label={`View details for ${job.title} at ${job.company}`}
                  >
                    Details
                  </Link>
